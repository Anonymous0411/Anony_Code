...
def execute_DAG_task1_2_critic(patient_key, DAG_dict, history_dialogue, history_diagnosis, second_room_list, train_executor=False, inference_con=False):
  ...
  for idx, single_node in enumerate(DAG_dict['nodes']):
    ...
    if single_node['node_id'] == 'final_answer':
      ...
      if train_executor:
        ...
        return final_answer_prompt, DAG_dict
      # print(final_answer_prompt)
      if inference_con:
