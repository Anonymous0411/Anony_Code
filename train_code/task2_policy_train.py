...
from reward_fun.reward_task2_policy import *
...
def build_dataset():
    ...
    with open('inference_process_data/task2/policy/train_prompt.json', 'r', encoding='utf-8') as file:
    ...
    for key, value in train_prompt_all.items():
        messages = [
            {"role": "system", "content": "你是一个医学检查策略生成Agent。"},
