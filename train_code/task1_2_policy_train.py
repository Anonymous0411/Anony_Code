...
from reward_fun.reward_task1_2_policy import *
...
def build_dataset():
    ...
    with open('inference_process_data/task1_level2/policy/train_data/task1_level2_policy_train_prompt.json', 'r', encoding='utf-8') as file:
        train_prompt_all = json.load(file)

    with open('inference_process_data/task1_level1/doctor_patient_interaction_result.json', 'r', encoding='utf-8') as file:
        doctor_patient_interaction_result = json.load(file)

    with open('inference_process_data/task1_level1/doctor_reasoning_result.json', 'r', encoding='utf-8') as file:
        doctor_reasoning_result = json.load(file)

    with open('inference_process_data/task1_level1/second_room_list.json', 'r', encoding='utf-8') as file:
    ...
    for key, value in train_prompt_all.items():
        messages = [
